...
3. Create *config/api.php* from *config/api.php.dist* file and add your API key (use DEMO_KEY as your key for nasa example)
...
```
5. Import `simple-mvc.sql` in your SQL server,
